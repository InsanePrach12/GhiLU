...
docker run -p 8000:8000 -e GEMINI_API_KEY=AIzaSy... -e LLM_MODEL=gemini-2.5-flash gridwise:latest
curl http://127.0.0.1:8000/health
```
...
- `google-genai` SDK — Gemini LLM calls (the rest of the pipeline is provider-agnostic)
